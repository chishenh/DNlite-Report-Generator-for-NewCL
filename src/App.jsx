...
export default function App() {
  ...
  const loadSample = () => {
    ...
    const sample = [
      ...
      ["XXX", "2024-12-24", "1001", "陳大文 (一般)", "88001", "男", "1980-05-20", "A123456789", "100", "1.0", "林翠仙", "古琪茗"],
      ["XXX", "2024-12-24", "1002", "李小美 (低值)", "88002", "女", "1990-08-15", "B234567890", "< 5.428", "1.0", "李家宏", "林珈妤"],
      ["XXX", "2024-12-24", "1003", "王大明 (高值)", "88003", "男", "1975-11-11", "C345678901", "300", "1.5", "曾盈慈", "林翠仙"]
    ];
    processData(sample);
  };
